...
<head>
    ...
    <title>Inactive Member</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">    
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.2/animate.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="/Fit/All/sadmin.css">
...
<body>
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            ...
            <h1 class="fs-4">
                <a class="navbar-brand" href="/Fit/All/Nmember.php">
            ...
            <div class="dashboard-content px-5 pt-4">
                ...
                <div class="d-flex py-3 flex-row bd-highlight mb-3">
                    ...
                    <div class="p-1 me-auto bd-highlight">
                        <button type="submit" name="inactive" class="active btn btn-outline-light btn-md"> 
                 ...
                 <div class="table-wrapper-scroll-y my-custom-scrollbar">
                    <table class="table table-dark table-hover align-middle table-striped  mb-0">
                       ...
                       <?php
                        include "db_conn.php";
                        $select = "SELECT * FROM `status` WHERE `Status` = 'Inactive' "; 
                           ...
                           <tr class="text-center ">
                               ...
                               <td>
                                   <div class="d-flex justify-content-evenly">
                                       <div class="p-0"> 
                                       <a href="Upinactive.php?Email=<?php echo $rows['Email'] ?>" class="nav-link"><i class="fa-solid fa-square-pen fa-xl"></i></a>
                                       </div>                                  
                                       <div class="p-0">
                                       <a href="Inactive.php?Email=<?php echo $rows['Email'] ?>"class="nav-link"><i class="fa-solid fa-trash fa-lg"></i></a>
                                       </div>
                                   </div>    
                               </td>
                           </tr>
