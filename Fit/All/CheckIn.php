...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="content d-flex justify-content-center align-items-center">
    <div class="dashboard-content px-5">
      <div class="d-flex flex-column align-items-center bd-highlight" id="Nmember">
        <div class="p-1 bd-highlight">
          <h2 class="fw-bold fs-2 pt-5">CHECK-IN</h2>
        </div>
        <div class="d-flex flex-row bd-highlight mt-3">
          <div class="p-1 flex-grow-1 bd-highlight mx-4 mb-5">
            <a href="TimeIn.php?Email=<?php echo $rows['Email'] ?>" class="btn btn-outline-light fw-bold btn-lg">Time-In</a>
          </div>
          <div class="p-1 flex-grow-1 bd-highlight mx-4 mb-5">
            <a href="TimeOut.php?Email=<?php echo $rows['Email'] ?>" class="btn btn-outline-light fw-bold btn-lg">Time-Out</a>
          </div>
        </div>
      </div>
    </div>
