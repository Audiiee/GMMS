        ...
        <div class="content">
            <div class="dashboard-content px-5 pt-4">
                ...
                <div class="d-flex py-3 flex-row bd-highlight mb-3">
                    ...
                    <div class="p-1 bd-highlight">
                        <button type="submit" name="active" class="active btn btn-outline-light btn-md"> 
                 ...
                 <div class="table-wrapper-scroll-y my-custom-scrollbar">
                    <table class="table table-dark table-hover align-middle table-striped  mb-0">
                       ...
                       <?php
                        include "db_conn.php";
                        $select = "SELECT * FROM `status` WHERE `Status` = 'Active'"; 
                           ...
                           <tr class="text-center ">
                               ...
                               <td>
                                   <div class="d-flex justify-content-evenly">
                                       <div class="p-0"> 
                                       <a href="Upactive.php?Email=<?php echo $rows['Email'] ?>" class="nav-link"><i class="fa-solid fa-square-pen fa-xl"></i></a>
                                       </div>                                  
                                       <div class="p-0">
                                       <a href="Active.php?Email=<?php echo $rows['Email'] ?>"class="nav-link"><i class="fa-solid fa-trash fa-lg"></i></a>
                                       </div>
                                   </div>    
                               </td>
                           </tr>
