            ...
            <div class="dashboard-content px-5 pt-2">
                ...
                <div class="d-flex justify-content-center" id="Nmember">
                  <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex bd-highlight">
                      <div class="p-1 pb-3 flex-grow-1 bd-highlight">
                         <label for="message-text" class="col-form-label">Email: <i>This email can't edit by the admin</i> </label>
                         <div class="input-group">
                 ...
                 <div class="row px-2 mb-3 mt-2">
                  ...
                  <button type="submit" name="pending" class="btn btn-outline-light btn-md me-2"><a class="nav-link" href="Members.php"> Back </a></button>  
